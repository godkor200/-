...
Tree.prototype.mapInPlace = function (callback) {
  ...
  for (let i = 0; i < this.children.length; i++) {
    newNode.children[i] = this.children[i].mapInPlace(callback);
  }
  return newNode;
};
...
let newTree = root1.mapInPlace(function (value) {
  return value * 2;
});
console.log("root1", root1);
console.log("newTree -> newTree", newTree);
